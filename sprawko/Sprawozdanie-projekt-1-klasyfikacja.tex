...
Zbiór testowy wszystkich próbnych klasyfikacji składał się z 6 dokumentów, każdy mówiący o innym państwie spośród: Francji, Zachodnich Niemiec, Kanady, Japonii, Ameryki oraz Wielkiej Brytanii. W klasyfikacji nr 1, 2 wykorzystano kolejno miarę M1, oraz M2. We wszystkich klasyfikacjach przyjmujemy wartość parametru K = 1 oraz ilość klasyfikowanych dokumentów równą 10.
