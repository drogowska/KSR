...
\begin{enumerate}
\item F1 - Pierwsza występująca nazwa geograficzna w danym tekście (Słownik nazw geograficznych) 
\item F2 - Pierwsza występujący symbol waluty w danym tekście (Słownik walut)
\item P1 - Najczęściej występujące nazwisko w danym tekście
\item P2 - Najczęściej występująca nazwa partii politycznej w danym tekście
\item N1 - Liczba słów związanych z Zachodnimi Niemcami w danym tekście
\item N2 - Liczba słów związanych z USA w danym tekście
\item N3 - Liczba słów związanych z Japonią w danym tekście
\item N4 - Liczba słów związanych z Francją w danym tekście
\item N5 - Liczba słów związanych z Wielką Brytanią w danym tekście
\item N6 - Liczba słów związanych z Kanadą w danym tekście
\end{enumerate}
