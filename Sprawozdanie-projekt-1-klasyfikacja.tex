...
W celu oceny jakości klasyfikacji dokumentów tekstowych \cite{teksty} przez algorytm, przyjęto konwencje nazewniczą oznaczeń $A_b$$_c$, potrzebną do wyznacznia miar jakości klasyfikacji, gdzie:
\begin{itemize}
...
Ocena klasyfikacji przez wykorzystany algorytm została wykonana przy pomocy następujących miar (wzory miar wykorzystują powyższą konwencje nazewniczą wartości):
\begin{enumerate}
