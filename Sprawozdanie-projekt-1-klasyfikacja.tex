...
do których badany element ma najbliżej dla wybranej metryki, a następnie wyznacza wynik w oparciu 
o głos większości. Parametrami wejściowymi algorymtu 
...
Poniżej znajduje się lista wyekstrahowanych cech liczbowych i tekstowych:
