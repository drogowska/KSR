...
\author{
  ...
  \studentinfo{Mateusz Srebnik}{nr albumu 2} }
...
zbioru dokumentów tekstowych względem kraju, którego dany tekst dotyczy. Aplikacja podzielona jest na moduł ekstrakcji 
cech tesktu oraz klasyfikatora. 
Ideą części badawczej projektu jest zbadanie wpływu wielkości parametru $k$
na dokłądość dopasowania etykiety, również porównanie metryk i miary podobieństwa tekstów.
...
do których badany element ma najbliżej dla wybrnej metryki, a następnie wyznacza wynik w oparciu 
o głos większości.
