...
zbioru dokumentów tekstowych (dostępnych do pobrania: http://archive.ics.uci.edu/ml/datasets/Reuters-21578+Text+Categorization
+Collection) względem kraju, którego dany tekst dotyczy. Aplikacja podzielona jest na moduł ekstrakcji 
