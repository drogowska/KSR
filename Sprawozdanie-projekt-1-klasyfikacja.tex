...
\end{itemize} \hfill \break
Pewne kombinacje wartości $A$, $b$ oraz $c$ są logicznie niepoprawne i nie będę wykorzystywane w sprawozdaniu, przykładowo:
\begin{itemize}
\item Wartość $F_{UK}$ $_{Canada}$ oznacza liczbę dokumentów traktujących o Wielkiej Brytanii, które niepoprawnie zostały zaklasyfikowane jako dokumenty traktujące o Kanadzie
\item Zapis „$P_{UK}$ $_{UK} = 12$" oznacza, że 12 dokumentów traktujących o Wielkiej Brytanii zostało zaklasyfikowane poprawnie 
\end{itemize} \hfill \break
