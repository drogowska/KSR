...
Miara ta pozwala ocenić jaki jest udział prawidłowo rozpoznanych przypdaków pozytywnie wśród wszystkich przypadków pozytywnych. Czułość jest również parametrem, który powinien przyjmować wartości jak najbliższe 1.\\
...
Im otrzymana wartość jest bliższa jedynce, tym lepiej to świadczy o algorytmie klasyfikującym. W najlepszym przypadku przyjmuje ona wartość 1, w przypadku kiedy czułość i precyzja algorytmu jest idealan. \\
